    ...
    <div className="max-w-3xl mx-auto w-full px-2 sm:px-4">
      <form onSubmit={handleSubmit} className="relative">
        <Textarea
          ...
          disabled={isLoading}
          className="min-h-[48px] sm:min-h-[60px] w-full pr-20 sm:pr-24 resize-none bg-[#40414F] border border-[#4D4D4F] focus-visible:ring-2 focus-visible:ring-[hsl(var(--chat-gradient-start))] text-white placeholder:text-white/50 rounded-lg text-sm md:text-base shadow-lg transition-all duration-200"
          rows={1}
        />
